...
from tools.parse_args import parse_args_mostpopular_postprocess, save_command_to_file
...
def main(args : ArgumentParser.parse_args) -> None:
    ...
    try:
        ...
        data = data_loader.prepare_csr_dataset(is_csr=True)
        ...
        diner_mapping = data["diner_mapping"]  # {external_id: internal_id}
        reranked_ids_internal = [
        ...
        metric_dict = metric_calculator.generate_recommendations_and_calculate_metric(
            ...
            most_popular_diner_ids=reranked_ids_internal,
...
if __name__ == "__main__":
    args = parse_args_mostpopular_postprocess()
    main(args)
